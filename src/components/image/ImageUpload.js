...
const ImageUpload = (props) => {
    ...
    return (
        <label
            ...
            w-full min-h-[200px] rounded-lg ${className} relative overflow-hidden group`}
        >
            <input
                type='file'
                name={name}
            ...
            {progress !== 0 && !image && (
                <div className='absolute w-16 h-16 border-8 border-green-500 rounded-full loading border-t-transparent animate-spin'>
            ...
            {!image && <div className='absolute bottom-0 left-0 w-10 h-1 transition-all bg-green-400 image-upload-progress'
                style={{
